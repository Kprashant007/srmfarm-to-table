...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">SRM Agrofield &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">SRM Agro Culture Farm<span>Chennai</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+91-7001904697</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="pq9329@srmist.edu.in" style="color:white">pq9329@srmist.edu.in</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About SRM Farm-to-table</b></span>
				SRM Farm-to-table is an e-commerce trading platform for grains & grocerries. 
			</p>
